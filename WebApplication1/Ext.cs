...
namespace WebApplication1 {
    ...
    public static class Ext {
        ...
        /// </param>
        public static WebApplication1.Net.CookieCollection GetCookies( this System.Collections.Specialized.NameValueCollection headers, bool response ) {
            var name = response ? "Set-Cookie" : "Cookie";
            return headers == null || !headers.Contains(name)
                   ? new WebApplication1.Net.CookieCollection()
                   : WebApplication1.Net.CookieCollection.Parse(headers[name], response);
        }

        /// <summary>
        /// Gets the description of the HTTP status code using the specified <see cref="WebApplication1.Net.HttpStatusCode"/>.
        /// </summary>
        /// <returns>
        /// A <see cref="string"/> that contains the description of the HTTP status code.
        /// </returns>
        /// <param name="code">
        /// One of <see cref="WebApplication1.Net.HttpStatusCode"/> values that contains an HTTP status code.
        /// </param>
        public static string GetDescription( this WebApplication1.Net.HttpStatusCode code ) {
        ...
        /// A <see cref="string"/> that contains a separator string.
        /// </param>
        public static System.Collections.Generic.KeyValuePair<string, string> GetNameAndValue( this string nameAndValue, string separator ) {
        ...
        /// <summary>
        /// Determines whether the specified <see cref="WebApplication1.ByteOrder"/> is host (this computer architecture) byte order.
        /// </summary>
        /// <returns>
        /// <c>true</c> if the <paramref name="order"/> parameter is host byte order; otherwise, <c>false</c>.
        /// </returns>
        /// <param name="order">
        /// A <see cref="WebApplication1.ByteOrder"/> to test.
        /// </param>
        public static bool IsHostOrder( this WebApplication1.ByteOrder order ) {
            // true : !(true ^ true)  or !(false ^ false)
            // false: !(true ^ false) or !(false ^ true)
            return !(BitConverter.IsLittleEndian ^ (order == WebApplication1.ByteOrder.LITTLE));
        }
        ...
        /// </param>
        /// <param name="srcOrder">
        /// A <see cref="WebApplication1.ByteOrder"/> that indicates the byte order of <paramref name="src"/>.
        /// </param>
        /// <typeparam name="T">
        ...
        /// </param>
        /// <param name="order">
        /// A <see cref="WebApplication1.ByteOrder"/> that indicates the byte order of the return.
        /// </param>
        /// <typeparam name="T">
        ...
        /// <summary>
        /// Writes the specified content data using the specified <see cref="WebApplication1.Net.HttpListenerResponse"/>.
        /// </summary>
        /// <param name="response">
        /// A <see cref="WebApplication1.Net.HttpListenerResponse"/> that contains a network stream to write a content data.
        /// </param>
        /// <param name="content">
